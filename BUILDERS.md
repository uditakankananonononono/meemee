...
| --- | --- | --- | --- | --- |
| PB1 | pb1 | Interactive browser human takeover (live sessions, takeover links, WebSocket live view, hand-back) | `meemee/browser_sessions.py`, `meemee/browser_api.py`, `meemee/tools/browser_session.py`, `tests/test_browser_takeover.py`, `docs/browser-takeover.md`; small hooks in `meemee/api.py`, `meemee/runtime.py`, `meemee/config.py` | shipped on pb1 |
