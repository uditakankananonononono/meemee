...
**Current core version:** 0.56.0  
**Ledger:** 80 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 172 passed; 110 SDK passed; Ruff and explicit 0.56.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 80-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.56.0 | 172 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.56.0 | clean |
