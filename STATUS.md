...
**Current core version:** 0.42.0  
**Ledger:** 65 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 138 core + 109 SDK passed; Ruff and release audit clean

## What is production-usable now

The authoritative detailed list is the 65-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.42.0 | 138 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.42.0 | clean |
