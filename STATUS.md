...
**Current core version:** 0.77.0  
**Ledger:** 101 verified, 0 thin  
...
**Last core verification:** 206 passed; 112 SDK passed; Ruff and explicit 0.77.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 101-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.77.0 | 206 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.77.0 | clean |
| SDK | v0.77.0 full run | 112 passed, including 11 against a booted server |
