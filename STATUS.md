...
**Current core version:** 0.63.0  
**Ledger:** 87 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 186 passed; 110 SDK passed; Ruff and explicit 0.63.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 87-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.63.0 | 186 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.63.0 | clean |
