...
**Current core version:** 0.51.0  
**Ledger:** 75 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 162 core + 110 SDK passed; Ruff and explicit 0.51.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 75-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.51.0 | 162 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.51.0 | clean |
