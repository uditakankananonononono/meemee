...
**Current core version:** 0.71.0  
**Ledger:** 95 verified, 0 thin  
...
**Last core verification:** 197 passed; 112 SDK passed; Ruff and explicit 0.71.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 95-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.71.0 | 197 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.71.0 | clean |
| SDK | v0.71.0 full run | 112 passed, including 11 against a booted server |
