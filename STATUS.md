...
**Current core version:** 0.70.0  
**Ledger:** 94 verified, 0 thin  
...
**Last core verification:** 196 passed; 112 SDK passed; Ruff and explicit 0.70.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 94-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.70.0 | 196 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.70.0 | clean |
| SDK | v0.70.0 full run | 112 passed, including 11 against a booted server |
