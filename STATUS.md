...
**Current core version:** 0.76.0  
**Ledger:** 100 verified, 0 thin  
...
**Last core verification:** 205 passed; 112 SDK passed; Ruff and explicit 0.76.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 100-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.76.0 | 205 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.76.0 | clean |
| SDK | v0.76.0 full run | 112 passed, including 11 against a booted server |
