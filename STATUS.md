...
**Current core version:** 0.36.0  
**Ledger:** 58 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 123 passed, Ruff clean

## What is production-usable now

The authoritative detailed list is the 58-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.36.0 | 123 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.36.0 | clean |
