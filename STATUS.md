...
**Current core version:** 0.50.0  
**Ledger:** 74 verified, 0 thin  
**Supported production shape:** one host, one or more API/worker processes, SQLite/WAL on local persistent storage  
**Last core verification:** 160 passed; Ruff and explicit 0.50.0 release audit clean

## What is production-usable now

The authoritative detailed list is the 74-item "Verified" section in [README.md](README.md). The main product surfaces are:
...
|---|---|---|
| Core server/runtime | `pytest -q` after v0.50.0 | 160 passed |
| Core lint | `ruff check meemee tests examples/webhook_receiver` after v0.50.0 | clean |
