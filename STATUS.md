...
**Current core version:** 0.106.0  
**Ledger:** 142 verified, 0 thin  
...
**Last core verification:** 300 passed; 133 SDK passed (15 live skipped); 5 PostgreSQL contract tests passed (2 live skipped); Ruff, package audit and explicit 0.106.0 release audit clean
...
- Password reset and self-serve account deletion for built-in accounts. External OIDC remains optional.
