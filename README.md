...
91. Core/SDK version parity at 0.69.0 with stale server-contract labels removed across package metadata, imports, README and live-integration documentation.
...
93. API/worker composition selection for PostgreSQL memory and owner-scoped queued jobs, with automatic ownership migration, owner reads/lists/events and leased worker execution; cursor parity remains explicit.
