...
4. The person sees the live page (JPEG frames about 3 per second) and can click, double-click, drag (slider challenges), type, press allowed keys, scroll and navigate within the session's domain policy.
